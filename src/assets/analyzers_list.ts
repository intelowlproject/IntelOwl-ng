export const saved_analyzer_config_json = {
  ...
  CloudFlare_DNS: {
    ...
    external_service: true,
    description:
      'Retrieve current domain resolution with CloudFlare DoH (DNS over HTTPS)',
    soft_time_limit: 30,
    python_module:
      'dns.dns_resolvers.cloudflare_dns_resolver.CloudFlareDNSResolver',
    additional_config_params: {
      query_type: 'A',
    },
  },
  ...
  Cymru_Hash_Registry_Get_File: {
    ...
    external_service: true,
    description:
      'Check if a particular file is known to be malware by Team Cymru',
  ...
  Cymru_Hash_Registry_Get_Observable: {
    ...
    external_service: true,
    description:
      'Check if a particular hash is available in the malware hash registry of Team Cymru',
    python_module: 'cymru.Cymru',
    soft_time_limit: 50,
  },
  DNSDB: {
    ...
    external_service: true,
    description:
      'scan an observable against the Passive DNS Farsight Database (support both v1 and v2 versions)',
    requires_configuration: true,
  ...
  DNStwist: {
    ...
    external_service: true,
    description:
      'scans for potentially malicious permutations of a domain name',
  ...
  Doc_Info_Experimental: {
    ...
    decription:
      'static document analysis with new features to analyze XLM macros, encrypted macros and more',
    python_module: 'doc_info.DocInfo',
    additional_config_params: {
      experimental: true,
    },
  ...
  Google_DNS: {
    ...
    external_service: true,
    description:
      'Retrieve current domain resolution with Google DoH (DNS over HTTPS)',
    soft_time_limit: 30,
  ...
  GreyNoiseAlpha: {
    ...
    external_service: true,
    description:
      'scan an IP against the Alpha Greynoise API (no API key required)',
    python_module: 'greynoise.GreyNoise',
    additional_config_params: {
  ...
  Hunter: {
    ...
    external_service: true,
    description:
      'Scans a domain name and returns set of data about the organisation, the email address found and additional information about the people owning those email addresses',
    requires_configuration: true,
  ...
  MalwareBazaar_Google_Observable: {
    ...
    external_service: true,
    description:
      'Check if a particular IP, domain or url is known to MalwareBazaar using google search',
  ...
  PEframe_Scan: {
    ...
    description:
      'Perform static analysis on Portable Executable malware and malicious MS Office documents',
    soft_time_limit: 500,
  },
  Phishtank: {
    type: 'observable',
  ...
  Quad9_DNS: {
    ...
    external_service: true,
    description:
      'Retrieve current domain resolution with Quad9 DoH (DNS over HTTPS)',
    soft_time_limit: 30,
  ...
  Quad9_Malicious_Detector: {
    ...
    external_service: true,
    description:
      'Check if a domain or an url is marked as malicious in Quad9 database',
    soft_time_limit: 30,
    python_module:
      'dns.dns_malicious_detectors.quad9_malicious_detector.Quad9MaliciousDetector',
  },
  Quark_Engine_APK: {
    type: 'file',
    supported_filetypes: [
  ...
  Securitytrails_History_WHOIS: {
    ...
    external_service: true,
    description:
      'scan a domain against securitytrails API for historical WHOIS',
    requires_configuration: true,
    python_module: 'securitytrails.SecurityTrails',
    additional_config_params: {
      securitytrails_analysis: 'history',
  ...
  Strings_Info_ML: {
    type: 'file',
    description:
      "strings extraction plus strings ranking based on Machine Learning. Leverages Fireeye's Stringsifter",
    python_module: 'strings_info.StringsInfo',
    additional_config_params: {
  ...
  Tranco: {
    ...
    external_service: true,
    description:
      'check if a domain is in the last Tranco ranking top sites list',
    python_module: 'tor.Tor',
    soft_time_limit: 30,
  },
  Triage_Scan: {
  ...
  VirusTotal_v2_Get_Observable: {
    ...
    disabled: true,
    description:
      'search an observable in the VirusTotal DB using the old API endpoints',
    requires_configuration: true,
    python_module: 'vt2_get.VirusTotalv2',
    additional_config_params: {
      api_key_name: 'VT_KEY',
  ...
  VirusTotal_v3_Get_File_And_Scan: {
    ...
    run_hash: true,
    description:
      'check file hash on VirusTotal. If not already available, send the sample and perform a new scan',
    requires_configuration: true,
    python_module: 'vt3_get.VirusTotalv3',
    additional_config_params: {
      api_key_name: 'VT_KEY',
  ...
  Whoisxmlapi: {
    ...
    external_service: true,
    description:
      'the WHOIS record data, of a domain name, an IP address, or an email address',
    requires_configuration: true,
