export const saved_analyzer_config_json = {
  ...
  ActiveDNS_CloudFlare_Malware: {
    ...
    external_service: true,
    description:
      'Detect malicious domains thanks to CloudFlare DoH Malware Filter',
    python_module: 'activedns_run',
    additional_config_params: {
  ...
  Strings_Info_ML: {
    type: 'file',
    description:
      'strings extraction plus strings ranking based on Machine Learning',
    python_module: 'stringsinfo_run',
    additional_config_params: {
  ...
  VirusTotal_v3_Get_File_And_Scan_Or_Rescan_If_Old: {
    ...
    run_hash: true,
    description:
      'check file hash on VirusTotal. If it is already available, rescan if it is old. If it is not available, send the sample and perform a new scan',
    requires_configuration: true,
    python_module: 'vt3get_scan_run',
    additional_config_params: {
      api_key_name: 'VT_KEY',
